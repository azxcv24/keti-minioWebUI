...
export const lightColors = {
  ...
  mainOrange: "#FFBD62",
  menuBackground:
    "linear-gradient(90deg, rgba(64,102,169,1) 0%, rgba(58,97,166,1) 50%, rgba(57,96,166,1) 100%)",
  menuDropArrowColor: "rgba(0,0,0,0.1)",
  menuDropArrowBackground: "rgba(0,0,0,0.1)",
  menuSelectedOption:
    "linear-gradient(90deg, rgba(0,0,0,0) 0%, rgba(166,166,166,1) 100%)",
  menuCommonColor: "#CADAE8",
  menuColorDivider: "rgba(255,255,255,0.2)",
  menuCollapseColor: "#E8E8E8",
  menuIconBG: "rgba(0,0,0,0.1)",
  menuIconBorder: "rgba(0,0,0,0.1)",
  tabBorder: "#EAEAEA",
