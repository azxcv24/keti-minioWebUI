...
const ObjectDetailPanel = ({
  ...
  const [previewPagingOpen, setPreviewPagingOpen] = useState<boolean>(false);
  ...
  const multiActionButtons = [
    ...
    {
      action: () => {
        setPreviewPagingOpen(true);
      },
      label: "Preview(Paging)",
      disabled:
        !!actualInfo.is_delete_marker ||
        (objectType === "none" && !canGetObject),
      icon: <PreviewIcon />,
  ...
  return (
    <Fragment>
      ...
      {previewPagingOpen && actualInfo && (
        <PreviewFileModal
          open={previewPagingOpen}
          bucketName={bucketName}
          object={{
            name: actualInfo.name || "",
            version_id: actualInfo.version_id || "null",
