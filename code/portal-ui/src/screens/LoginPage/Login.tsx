...
const Login = () => {
  ...
  return (
    <Fragment>
      <MainError />
      <LoginWrapper
        logoProps={{ applicationName: "console", subVariant: 'simple' }}
        form={loginComponent}
        formFooter={<Footer isK8S={isK8S} />}
        promoHeader={
          <span style={{ fontSize: 28 }}>KETI-IO</span>
        }
        promoInfo={
          <span style={{ fontSize: 14, lineHeight: 1 }}>
            KETI-IO is a cloud-native object store built to run on any
